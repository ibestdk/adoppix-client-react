        ...
        >
          <div className="flex justify-end mx-8">
            <div
              ...
              className="rounded-full h-11 w-11 mx-1 mt-2 hover:bg-adoplighticon duration-300"
            >
              <AiFillStar className="h-11 w-11 p-2 text-yellow-300" />
            </div>
            <div
              onClick={navigateToCart}
              className="hover:bg-adoplighticon gove duration-300 rounded-full h-11 w-11 mx-1 mt-2"
            >
            ...
            <div className="rounded-md p-10 shadow-md shadow-gray-300 py-10 mt-5">
              {wishlist &&
                wishlist.map((data, dataIndex) => (
                  <div
                    key={dataIndex}
                    className="my-5 grid grid-cols-6 gap-4 place-items-center"
                  >
                    <div
                    ...
                    <div className="inline-block col-span-3">
                      ...
                      <div className="mt-2">
                        ...
                        >
                          ...
                          <div className="inline-block">ย้ายไปยังรถเข็น</div>
                        </div>
                      </div>
                    </div>
                    <div>
