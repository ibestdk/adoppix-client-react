...
export const AuctionBoard = ({money , auctionData , dateExpire , timeExpire , handleBids ,bids, bidsAuction, multiple}) => {
    return(
                    ...
                    {auctionData && (
                      <div className="mt-7">
                        <div className="flex justify-center">
                          <div onClick={() => multiple(1.2)} className="cursor-pointer w-14 h-9 py-2 text-center mx-1 text-sm font-bold px-4 rounded-lg  bg-adoppix text-adoplight ">
                            x1.2
                          </div>
                          <div onClick={() => multiple(1.5)} className="cursor-pointer w-14 h-9 py-2 text-center mx-1 text-sm font-bold px-4 rounded-lg  bg-adoppix text-adoplight ">
                            x1.5
                          </div>
                          <div onClick={() => multiple(2)} className="cursor-pointer w-14 h-9 py-2 text-center mx-1 text-sm font-bold px-4 rounded-lg  bg-adoppix text-adoplight ">
                            x2
                          </div>
                        </div>
                        <div>
