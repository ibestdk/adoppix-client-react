        ...
        >
          <div className="bg-adopsoftdark w-[400px] h-[200px] rounded-lg p-4 flex flex-col justify-between">
            ...
            <div className="flex justify-end items-end">
              <div onClick={() => setConfrimModal(false)} className="cursor-pointer mx-2 px-2 py-1 rounded-lg border-white border-2 text-base">
                ย้อนกลับ
              </div>
              <div onClick={() => onClose()} className="cursor-pointer mx-2 px-2 py-1 rounded-lg bg-red-600 text-base">
                ยกเลิก
              </div>
            </div>
          </div>
            ...
            <div className="flex">
              <div className="flex flex-col items-center">
                ...
                <div className="relative">
                  <div className="border-l-2 h-[60px] left-[50%]absolute mt-2 dark:border-adoplighticon"></div>
                </div>
              </div>
              <div>
