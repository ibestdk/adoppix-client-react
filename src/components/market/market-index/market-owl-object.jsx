...
export default function MarketOwlObject({ object,setTagOwlCol }) {
  ...
  return (
    <div className="p-2">
      <div onClick={() => {setTagOwlCol(object.title)}} className="relative rounded-md h-16 w-32 flex justify-center cursor-pointer hover:scale-105 duration-300">
