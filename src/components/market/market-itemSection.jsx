    ...
    return(
        <div className="container">
            <div className="dark:bg-adopsoftdark dark:text-adoplight dark:shadow-md text-adopdark m-[1rem_0] p-4 shadow-[0_0_5px_lightgray] rounded-[.5rem]">
                ...
                <div className="grid grid-cols-5 gap-6 pt-2 pb-5">
                        ...
                        <div className="relative">
                            <div key={dataIndex} className="dark:shadow-md shadow-[0_0_5px_lightgray] rounded-md h-72 bg-adopdark relative overflow-hidden">
                                ...
                                <div className="h-16 hover:h-36 absolute w-full bottom-0 duration-300">
                                    ...
                                    <div className="text-3xl text-adoppix z-50 absolute right-3 cursor-default">
                                        <b>
                                            {data.price}
                                        </b>
                                    </div>
                                    <div className="text-sm text-adoplight z-50 absolute right-3 top-9 cursor-default">
                                        <b>
